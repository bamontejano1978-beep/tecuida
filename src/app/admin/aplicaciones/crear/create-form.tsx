...
interface FormData {
  ...
  nivel_suscripcion: 'basico' | 'estandar' | 'premium'
  activa: boolean
}
    ...
    try {
      const res = await fetch('/api/admin/applications', {
        ...
        body: JSON.stringify({
          ...
          tipo: formData.tipo,
          nivel_suscripcion: formData.nivel_suscripcion,
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            value={formData.nivel_suscripcion}
            onChange={(e) =>
              updateField(
                'nivel_suscripcion',
                e.target.value as FormData['nivel_suscripcion'],
              )
            }
            className="mt-1 block w-full border border-gray-300 rounded-lg px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none"
          >
